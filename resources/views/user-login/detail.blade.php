                    ...
                    <div class="card-body py-2 px-3">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="row col-12">
                                ...
                                <span
                                    class="col-6 py-2">{{ \Carbon\Carbon::parse($data->created_at)->format('d M
                                                                    Y') }}</span>
                            </div>
                        </div>
                        <!-- Responsibler -->
                        ...
                        <div class="row mb-5 dynamic-element-parent" data-name="legal-aspect">
                            ...
                            @foreach ($data->legalist as $index => $legal)
                                <div class="row col-12 my-3">
                                    ...
                                    <span
                                        class="col-6 py-2">{{ \Carbon\Carbon::parse($legal->date)->format('d M Y') }}</span>
                        ...
                        <div class="row mb-5 dynamic-element-parent" data-name="factory">
                            ...
                            @foreach ($data->factory as $index => $fac)
                                <div class="row col-12 my-3">
